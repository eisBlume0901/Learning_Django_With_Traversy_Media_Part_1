...
SECRET_KEY = 'django-insecure-lqyv1oh422_-(f7+d&0!l11x5_ev8qm8)&rufazplorex)8cuf'
...
INSTALLED_APPS = [
    'polls.apps.PollsConfig', # Add the polls app so that Django knows to include it
